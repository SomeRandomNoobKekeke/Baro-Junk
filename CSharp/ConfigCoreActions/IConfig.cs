...
namespace BaroJunk
{
  ...
  public partial interface IConfig : IConfigEntry
  {
    ...
    public ConfigCore Mixin => ConfigCore.Mixins.GetValue(this, c => new ConfigMixin(c));
    ...
    IConfigEntry IConfigEntry.GetEntry(string entryPath) => Mixin.Model.GetEntry(entryPath);
